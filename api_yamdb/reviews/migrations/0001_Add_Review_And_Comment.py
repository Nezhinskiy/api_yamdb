# Generated by Django 3.2.15 on 2022-08-09 15:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_id', models.ForeignKey(help_text='Ревью, к которой будет относиться комментарий', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='reviews.review', verbose_name='Ревью')),
            ],
        ),
    ]
